...
Rscript --vanilla $scriptsDir/scripts/MakeGeneSymbolTableLiftOffTOGA.R

# Add orthofinder genes

Rscript --vanilla $scriptsDir/scripts/AddOrthoFinderGenes.R

# Generate final gff

Rscript --vanilla $scriptsDir/scripts/FormatFinalGFF.R


cp full_annotation.geneSymbols.gff $outDir
